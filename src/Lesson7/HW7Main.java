...
import Lesson7.Forecast.DailyForecast;
import Lesson7.Forecast.WeatherFC;
...
public class HW7Main {
    public static void main(String[] args) throws IOException {
        OkHttpClient client = new OkHttpClient()
                ...
                .build();
        String responseBody;
        String cityCode = "295212"; //В accuweather API очень странная реализация поиска локации, поэтому я захардкодил название города
        ...
        ObjectMapper mapper = JsonMapper.builder()
                ...
                .build();
        WeatherFC forecast = mapper.readValue(responseBody, WeatherFC.class);
        DailyForecast[] forecastTemp = forecast.getDailyForecasts();
        for (DailyForecast df : forecastTemp) {
            System.out.println("In Saint Petersburg on date " + df.getDate().toLocalDate() +
